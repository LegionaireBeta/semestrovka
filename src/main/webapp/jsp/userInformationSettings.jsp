...
<div class="main">
    <c:forEach items="${settingsForJsp}" var="result">
        <form action="/userInformationSettings" method="post">
            <div class="inputs">
                <label>First Name</label>
                <input name="name" value="${result.firstNameOfUser}">
            </div>
            <div class="inputs">
                <label>Surname</label>
                <input name="surname" value="${result.surnameOfUser}">
            </div>
            <div class="inputs">
                <label>Age</label>
                <input type="date" name="age" value="${result.ageOfUser}">
            </div>
            <div class="inputs">
                <div class="gender">
                    <input type="radio" name="gender" id="male" value="male" ${"male".equals(result.genderOfUser) ? 'checked' : ''}>
                    <label for="male">Male</label>
                </div>
                <div class="gender">
                    <input type="radio" name="gender" id="female" value="female" ${"female".equals(result.genderOfUser) ? 'checked' : ''}>
                    <label for="female">Female</label>
                </div>
            </div>
            <div class="inputs">
                <label>Country</label>
                <input name="country" value="${result.countryOfUser}">
            </div>
            <div class="inputs">
                <label>City</label>
                <input name="city" value="${result.cityOfUser}">
            </div>
